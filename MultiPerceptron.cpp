...
void MultiPerceptron::save_model(string model_file)
{ 
...
void MultiPerceptron::load_model(string model_file)
{
...
void MultiPerceptron::read_samp_file(string samp_file, vector<feature> &samp_feat_vec, vector<int> &samp_class_vec) {
